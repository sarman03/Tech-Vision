  ...
  return (
    <div className='flex justify-between items-center p-4'>
      ...
      <div className='max-md:hidden w-[400px] rounded-full flex'>
        <input className='flex-grow bg-[#FFF8EB] rounded-l-full border-none outline-bnone text-sm pl-4 py-3 '
        ...
        <div className="max-sm:hidden flex gap-6">
          {topRoutes.map((route) => (
            <Link
              ...
              onClick={route.requiresAuth && route.label === "Instructor" ? handleInstructorClick : undefined}>
              {route.label}
            </Link>
          ))}
        </div>
